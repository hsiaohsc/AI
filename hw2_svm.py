...
clf = Pipeline([('vect',CountVectorizer(max_features=5000)),
                ...
                ('clf',SGDClassifier(alpha=0.001,max_iter=100)),])   #svm classifier
...
print(precision)
print('CV.max_features=5000,alpha=0.0001,max_iter=100')

from sklearn.externals import joblib
joblib.dump(clf,'svm_model_2.m')   #clf model stored as svm_model.m
print('...model stored...')
